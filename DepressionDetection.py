...
def open_camera():
    ...
    if score_displayed or not vid.isOpened() or not ret:
        ...
        if index==1 and confidence_score >= 0.8:
            cv2.putText(frame,"Lying",(60,20), cv2.FONT_HERSHEY_SCRIPT_SIMPLEX, 1, (0, 0, 200), 2)
...
base.attributes("-alpha", 1)  # set transparency
...
question_label = Label(base, text='', width=80, font=("bold", 14), bg='#6699CC', fg='white')
